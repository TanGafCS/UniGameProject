...
public class BarrelEntity extends Entity implements Interactable {

    private int value;

    public BarrelEntity(Floor floor, Vector2f pos, int value)
    {
        super(floor);
        this.value = value;
        this.setPos(pos);
    ...
    public void onInteract(Entity interactingEntity)
    {
        ...
        {
            getFloor().getPlayer().addBarrels(this.value);
    ...
    public Drawable getDrawable()
    {
        ...
        Texture t = Textures.getTexture("barrel");
