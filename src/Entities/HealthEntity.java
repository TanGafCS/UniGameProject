...
public class HealthEntity extends Entity implements Interactable {
    private int value;

    public HealthEntity(Floor floor, Vector2f pos, int value)
    {
        super(floor);
        this.value = value;
        this.setPos(pos);
    ...
    public void onInteract(Entity interactingEntity)
    {
        ...
        {
            getFloor().getPlayer().setHealth(getFloor().getPlayer().getHealth() + this.value);
    ...
    public Drawable getDrawable()
    {
        ...
        Texture t = Textures.getTexture("heart");
